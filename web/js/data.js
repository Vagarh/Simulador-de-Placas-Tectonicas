/**
 * Datos del Simulador de Placas Tectónicas
 * Información geológica y configuración de eras
 */

// Configuración de eras - ORDEN CORREGIDO de pasado a presente
const ERA_CONFIG = {
    // Índice 0: -350 Ma (Pangea Primitiva)
    0: {
    ...
    // Índice 1: -300 Ma (Pangea completa)
    1: {
        name: 'Pangea (-300 Ma)',
        year: -300,
    ...
    // Índice 4: -150 Ma (Cretácico Medio)
    4: {
    ...
    // Índice 5: -100 Ma (Cretácico Tardío)
    5: {
...
// Orden de las eras para la línea de tiempo
const ERA_TIMELINE_ORDER = [0, 1, 2, 3, 4, 5, 6, 7];
...
// Colores para placas tectónicas
const PLATE_COLORS = {
    101: { name: 'Norteamérica', color: [139, 90, 43, 200] },      // Marrón
    201: { name: 'Sudamérica', color: [46, 139, 87, 200] },        // Verde mar
    301: { name: 'Eurasia', color: [160, 82, 45, 200] },           // Marrón claro
    401: { name: 'África', color: [34, 139, 34, 200] },            // Verde
    501: { name: 'India', color: [184, 134, 11, 200] },            // Dorado
    601: { name: 'Australia', color: [210, 105, 30, 200] },        // Chocolate
    701: { name: 'Antártida', color: [200, 200, 220, 200] },       // Gris azul
    801: { name: 'Pacífico', color: [70, 130, 180, 200] },         // Azul acero
    901: { name: 'Nazca', color: [255, 140, 0, 200] },             // Naranja
    1001: { name: 'Filipina', color: [128, 0, 128, 200] },         // Púrpura
    1101: { name: 'Caribe', color: [0, 128, 128, 200] },           // Verde azulado
    default: { name: 'Desconocida', color: [128, 128, 128, 200] }  // Gris
};

// Límites de placas tectónicas (coordenadas aproximadas)
...
// Centros de placas para vectores de movimiento
const PLATE_CENTERS = [
...
// Información de placas para tooltips
const PLATE_INFO = {
